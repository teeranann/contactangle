function [Data]=EllipticFitVol(edgeL,edgeR,baseL,baseR,nupline)
...
efL.a=[];
efR.a=[];
% efL=fit_ellipse(left(1:indexL,1),left(1:indexL,2));
% efR=fit_ellipse(right(1:indexR,1),right(1:indexR,2));
efL=fit_ellipse(left(:,1),left(:,2));
efR=fit_ellipse(right(:,1),right(:,2));
